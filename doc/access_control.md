...
Encrypted packings (described in the [Upspin Security document](security.md))  in
...
the [Upspin Security document](security.md)), which is impractical at best.
...
[Overview document](overview.md)'s section on users.
